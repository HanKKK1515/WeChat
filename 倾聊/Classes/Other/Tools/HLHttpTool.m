...
@interface HLHttpTool() <NSURLSessionDownloadDelegate,NSURLSessionTaskDelegate> {
    //下载
    HLHttpToolProgressBlock _dowloadProgressBlock;
    HLHttpToolCompletionBlock _downladCompletionBlock;
    NSURL *_downloadURL;
    
    //上传
    HLHttpToolProgressBlock _uploadProgressBlock;
    HLHttpToolCompletionBlock _uploadCompletionBlock;
...
#pragma mark - 上传
- (void)uploadData:(NSData *)data url:(NSURL *)url progressBlock:(HLHttpToolProgressBlock)progressBlock completion:(HLHttpToolCompletionBlock)completionBlock {
